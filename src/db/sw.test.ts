...
function setup() {
  ...
  const caches = { open: vi.fn().mockResolvedValue(cache), keys: vi.fn().mockResolvedValue(["other-app", "dnevnik-v12", "dnevnik-v14-navigation"]), delete: vi.fn().mockResolvedValue(true), match: vi.fn().mockResolvedValue(undefined) };
